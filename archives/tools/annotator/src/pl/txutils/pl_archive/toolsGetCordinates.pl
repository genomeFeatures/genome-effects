...
Example: perl toolsGetCordinates.pl -o features -v mm10 -a GRCm38-ensGene 
...
$gene_prediction="";$prediction_ids="";$gene_prediction=$opt_a; $qh_getPredId->execute($gene_prediction);
