...
#Load scripts path into data structure

$load_annotations="$dir/pl/graber_txdb/load_annotations.pl"; $download_ensGeneDesc="$dir/pl/graber_txdb/download_ensGeneDesc.pl";
